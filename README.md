...
cursor (gentle parallax) and turns slightly as you scroll. The founders'
...
sits after the founders section — the complete stacked lockup (tagline
...
the founders mark panel, and the footer text line.
...
1. Real photo of Keith & Jordan (top priority).
